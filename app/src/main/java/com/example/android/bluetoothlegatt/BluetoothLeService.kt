...
class BluetoothLeService : Service() {
    ...
    private fun broadcastUpdate(action: String, characteristic: BluetoothGattCharacteristic) {
        ...
        if (UUID_DEVICE_ON_OFF == characteristic.uuid) {
            ...
            if (data != null && data.size > 0) {
                ...
                intent.putExtra(EXTRA_DATA, data[0].toString() + "\n" + stringBuilder.toString())
            }
        }
        sendBroadcast(intent)
    }
    ...
    companion object {
        ...
        val UUID_LUNCHBOX_SERVICE = UUID.fromString(SampleGattAttributes.LUNCHBOX_SERVICE)
        val UUID_DEVICE_ON_OFF = UUID.fromString(SampleGattAttributes.DEVICE_ON_OFF)
    }
}
